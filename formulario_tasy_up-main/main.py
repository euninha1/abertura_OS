...
async def validate_user(user: User):
    ...
    try:
        ...
        FROM tasy.usuario a  
        WHERE a.nm_usuario = :username AND a.cd_setor_atendimento = 127
        """
        ...
        if result is not None:
            ...
            raise HTTPException(status_code=200, detail="Usuário inválido")
...
if __name__ == "__main__":
    uvicorn.run(app, host="10.222.1.25", port=5500)
